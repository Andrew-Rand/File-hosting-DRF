...
class TestAuthorizedRequest:
    ...
    @pytest.mark.django_db
    def test_authorized_chunk_upload_get(self, test_client: APIClient,
    ...
    @pytest.mark.django_db
    def test_authorized_chunk_upload_post(self, test_client: APIClient,
                                          create_user_and_get_token: Tuple[User, str]) -> None:
    ...
    @pytest.mark.django_db
    def test_authorized_download_all_file_as_zip(self, test_client: APIClient,
                                                 create_user_and_get_token: Tuple[User, str]) -> None:
    ...
    @pytest.mark.django_db
    def test_authorized_all_user_files(self, test_client: APIClient,
                                       create_user_and_get_token: Tuple[User, str]) -> None:
    ...
    @pytest.mark.django_db
    def test_authorized_file_detail_get(self, test_client: APIClient,
                                        file_create: File,
                                        create_user_and_get_token: Tuple[User, str]) -> None:
    ...
    @pytest.mark.django_db
    def test_authorized_file_detail_patch(self, test_client: APIClient,
                                          file_create: File,
                                          create_user_and_get_token: Tuple[User, str]) -> None:
    ...
    @pytest.mark.django_db
    def test_authorized_file_detail_delete(self, test_client: APIClient,
                                           file_create: File,
                                           create_user_and_get_token: Tuple[User, str]) -> None:
    ...
    @pytest.mark.django_db
    def test_authorized_file_download(self, test_client: APIClient,
                                      file_create: File,
                                      create_user_and_get_token: Tuple[User, str]) -> None:
    ...
    @pytest.mark.django_db
    def test_authorized_file_upload(self, test_client: APIClient,
                                    file_create: File,
                                    create_user_and_get_token: Tuple[User, str]) -> None:
    ...
    @pytest.mark.django_db
    def test_authorized_file_build(self, test_client: APIClient,
                                   file_create: File,
                                   create_user_and_get_token: Tuple[User, str]) -> None:
